...
@section('title', 'Jurnal & Berita KKN - Super Susu Cipageran')
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-6 md:mt-10 mb-20 space-y-8">
    ...
    <nav class="flex text-sm text-gray-500 font-medium mb-6">
        ...
        <span class="text-gray-900">Jurnal KKN</span>
    </nav>
    ...
    <section class="bg-green-600 rounded-[2rem] p-10 md:p-16 text-center text-white relative overflow-hidden shadow-md">
        ...
        <div class="relative z-10">
            <h1 class="text-3xl md:text-5xl font-extrabold tracking-tight mb-4">Jurnal Dampak KKN</h1>
            <p class="text-green-100 max-w-2xl mx-auto text-lg">Dokumentasi kegiatan, pencapaian UMKM, dan cerita di balik proses pemberdayaan peternak susu Sentra Cipageran.</p>
        </div>
    </section>
    ...
    <section>
        @if($articles->isEmpty())
            <div class="bg-gray-50 rounded-2xl p-16 text-center border border-gray-100 mt-8">
                ...
                <p class="text-gray-500 text-sm">Tim KKN belum mengunggah jurnal atau berita terbaru.</p>
            </div>
        @else
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12">
                ...
                <article class="bg-white rounded-2xl overflow-hidden border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col group">
                    <div class="aspect-[4/3] bg-gray-200 relative overflow-hidden">
                        <img src="{{ $article->image ? asset($article->image) : 'https://placehold.co/600x400/e2e8f0/475569?text=Berita+Cipageran' }}" alt="{{ $article->title }}" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500">

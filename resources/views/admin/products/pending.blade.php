...
<body>
    <div class="container">
        ...
        <div class="admin-navbar">
            <a href="#" class="navbar-btn active">📦 Produk</a>
            <a href="#" class="navbar-btn">📰 Berita</a>
            <a href="#" class="navbar-btn">🏢 Profil</a>
            <a href="#" class="navbar-btn">🛍️ UMKM</a>
        </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="action-buttons">
                                ...
                                <form action="/admin/products/{{ $product->id }}/reject"
                                    method="POST">
                                    @csrf
